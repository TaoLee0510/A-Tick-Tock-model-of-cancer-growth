...
#ifndef SavePNGHR_hpp
#define SavePNGHR_hpp
...
inline void SavePNGHR(int Visual_range_x, int Visual_range_y, const CellArray &cell_array, int H, int &T, double alpha, double beta,double deltah)
{
