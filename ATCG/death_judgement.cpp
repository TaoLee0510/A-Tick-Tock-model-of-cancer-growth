...
void clear_dead_cell_visual(int site, CellStore &cell_array, VisualRange &Visual_range, int C)
{
    int idx = site - 1;
...
void compact_after_death_judgement(CellStore &cells, VisualRange &Visual_range, int, int nthreads, int C)
{
