...
inline void read_file(CellStore &cells,Array<long,2> &cell_trace, Array<double,2> &Parameters_array, string Cell_arry_file,string Cell_trace_arry_file,string Parameters)
{
    ifstream file;
    int LINES;
    file.open(Cell_arry_file,ios::in);
