...
int choose_large_stage_square(int x1, int y1, const VisualRange &Visual_range, long cell_rng_id, long rng_time_step, long &rng_event)
{
    int candidates[4] = {0};
    int count = 0;
    long loci_cor[9] = {0};
...
void square_loci(int stage_square, int x1, int y1, int xs[4], int ys[4])
{
    if (stage_square == 1)
    {
...
void apply_large_stage_square(int row, CellStore &cells, VisualRange &Visual_range, int stage_square, int x1, int y1)
{
    int xs[4] = {0};
    int ys[4] = {0};
...
int choose_small_stage_direction(int x1, int y1, const VisualRange &Visual_range, long cell_rng_id, long rng_time_step, long &rng_event)
{
    int candidates[8] = {0};
    int count = 0;
...
void direction_locus(int direction, int x1, int y1, int &x2, int &y2)
{
...
void apply_small_stage_direction(int row, CellStore &cells, VisualRange &Visual_range, int &cell_label, int direction, int x1, int y1)
{
    int x2 = x1;
    int y2 = y1;
...
void stage_convert(int Visual_range_x, int Visual_range_y, CellStore &cells, VisualRange &Visual_range, int &cell_label,int utralsmall,long rng_time_step)
{
    const int row_count = cells.rows();
