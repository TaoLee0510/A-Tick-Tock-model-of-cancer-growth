...
void save_data(int Visual_range_x, int Visual_range_y, int N0, int N00, int N01, int MMR, int H, int &T, float alpha, float beta, Array<float,2> cell_array, int migration_judgement,double deltah, Array<double,2> colorspace, int DDM, int allpng)
{
    if (H%MMR==0)
    {
        ...
        char filedir6 [100] = {'\0'};
        sprintf(filedir6, "/Users/zafiro/Library/Fonts/Calisto MT.ttf");
        FILE * fid4;
        ...
        sprintf(filedir12, "/Users/zafiro/Library/Fonts/Calisto MT.ttf");
        FILE * fid6;
    ...
    if (allpng==1)
    {
        ...
        char filedir9 [100] = {'\0'};
        sprintf(filedir9, "/Users/zafiro/Library/Fonts/Calisto MT.ttf");
        FILE * fid5;
        ...
        sprintf(filedir15, "/Users/zafiro/Library/Fonts/Calisto MT.ttf");
        FILE * fid7;
