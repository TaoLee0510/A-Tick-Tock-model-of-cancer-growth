//
//  DeathJudgementMultiThreads.hpp
//  CCDS
//
...
#ifndef DeathJudgementMultiThreads_hpp
#define DeathJudgementMultiThreads_hpp
...
void DeathJudgementMultiThreads(int Visual_range_x, int Visual_range_y, int N00, int N01, double r_limit, double K_limit, double lambda_r, double lambda_K, float alpha, float beta, double carrying_capacity_r, double carrying_capacity_K, double Cr, double CK, double death_time_range_r, double death_time_range_K, double deltah, double &h, Array<float, 2> &cell_array, Array<float,2> &cell_array_temp, Array<int, 3> sub_visual, Array<int,3> &Visual_range, double deathjudge, int Col,int nthreads)
{
    std::random_device r;
...
#endif /* DeathJudgementMultiThreads_hpp */
